...
search_conn  = mongoose.createConnection('mongodb://pweyand:Fvnjty0b@ds147510.mlab.com:47510/colors_search');

search_conn.on('error', function(err){
  if(err) throw err;
});

search_conn.once('open', function callback () {
  console.info('Mongo db connected successfully');
});

module.exports = search_conn;